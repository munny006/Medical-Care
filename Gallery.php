		...
		<div class="dark-overlay">
			...
			<div class="row">
				<div class="col mt-5 pt-5">
					...
					<p class="lead display-5">check out the photos</p>
				</div>
	...
	<section id="gallery" class="py-5" uk-lightbox>
		<div class="container">
			<div class="row pt-0 pt-md-3">
				<?php
					$fileHandle = fopen("files/galleries.csv", "r");
					//Loop through the CSV rows.
					while (($row = fgetcsv($fileHandle, 0, ",")) !== FALSE) {
				?>
				<div class="col-md-4">
					<div>
						<a href="img/<?=$row[0]?>"><img src="img/<?=$row[0]?>" class="img-fluid picture-2" style="height: 200px;margin-bottom: 17px;width: 100%"></a>
					</div>
				</div>
					<?php
				    }
